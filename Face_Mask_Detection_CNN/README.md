...
## ⚖️ License
This project is licensed under the MIT License - see the [LICENSE]([./LICENSE](https://github.com/foroughm423/Face_Mask_Detection_CNN/blob/main/LICENSE)) file for details.
